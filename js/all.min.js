...
$(document).ready(function(){$(".note .hide").click(function(){$(this).parents('.note').hide();});$(".dontsavebutton").click(function(){item=$(this).attr('id');item=item.replace(/dontsave/,'');$("#"+item).html('<strong>editing cancelled</strong>');});$("a.ajaxable").click(function(){var url=this.href;var thispage=urlParameter('page',window.location.href);var action=urlParameter('action',url);if(action==""){url+='&action='+thispage;}
